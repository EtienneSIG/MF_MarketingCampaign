...
- Available tables: CRM (customers, accounts, segments, interactions, profiles), Marketing (campaigns, assets, sends, events, audiences), Commerce (orders, products, returns)
...
6. Churn: customers with churn_risk_score > 60 or lifecycle_stage 'at_risk'/'churned' require immediate action
...
- Power BI visualization if relevant (funnel, bar chart, line chart)
